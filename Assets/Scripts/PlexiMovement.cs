...
public class PlexiMovement : MonoBehaviour
{
    ...
    private BallHeightHandler bhHandler;
    private BallLocationHandler blHandler;
    ...
    private void Awake()
    {
        ...
        drawGraph = GraphObject.GetComponent<DrawGraph>();
        ...
        blHandler = BallLocationHandlerObject.GetComponent<BallLocationHandler>();
        bhHandler = BallHeightObject.GetComponent<BallHeightHandler>();
    }
